package capacitor.plugin.facebook.login.enhance;
...
@CapacitorPlugin(name = "FacebookLoginEnhance", requestCodes = {FacebookLoginEnhancePlugin.FACEBOOK_SDK_REQUEST_CODE_OFFSET})
public class FacebookLoginEnhancePlugin extends Plugin {

    CallbackManager callbackManager;
    private AppEventsLogger logger;
    private final String TAG = "FacebookLoginEnhance";
    ...
    public void load() {
        ...
        this.logger = AppEventsLogger.newLogger(this.getActivity());
            ...
            while (iter.hasNext()) {
                ...
                try {
                    ...
                    try {
                        ...
                        // Nope
                        Log.e(TAG, "Type in AppEvent parameters was not Int for key:  " + key);
                    }
                }
            }
